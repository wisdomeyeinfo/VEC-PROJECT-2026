        ...
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-6 h-16">
          <div className="flex items-center gap-3">
            <Link href="/staff" className="flex items-center gap-2 group">
              <div className="h-10 w-10 rounded-xl bg-secondary flex items-center justify-center shadow-lg group-hover:scale-105 transition-transform">
                <GraduationCap className="h-6 w-6 text-primary" />
              </div>
              <div className="flex flex-col">
                <span className="font-black text-secondary tracking-tight italic uppercase">VEC Administration</span>
                <span className="text-[10px] font-black text-primary uppercase tracking-widest leading-none">Official Portal</span>
              </div>
            </Link>
          </div>
          ...
          <form action={staffSignOut}>
            <button
              className="flex items-center gap-2 px-4 py-2 rounded-xl text-secondary/40 hover:text-red-500 hover:bg-red-50 transition-all font-black text-[10px] uppercase tracking-widest"
              type="submit"
            >
